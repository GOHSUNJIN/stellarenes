...
window.STARS = {
  ...
  DATA: [
    ...
    { id:'spiralling',  title:'When you feel yourself spiralling',when:'for the racing days',        color:'hsl(165,55%,66%)', x:38.3, y:76,   notes:[ { code:'drift',      text:M.drift      } ] },
    { id:'restless',    title:'When you feel restless at night',  when:'for the 3am days',           color:'hsl(265,58%,78%)', x:40.1, y:37,   notes:[ { code:'moonlight',  text:M.moonlight  } ] },
    ...
    { id:'nostalgic',   title:'When you miss the old days',       when:'for the looking-back days',  color:'hsl(300,55%,76%)', x:73.5, y:84,   notes:[ { code:'stardust',   text:M.stardust   } ] },
